...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "http://localhost:5000", "http://localhost:5173", "http://localhost:3000", "https://feedbacksystem-production-e7d4.up.railway.app", "https://feedbacts.online"],
    },
  },
